...
public abstract class BaseUserType  implements Comparable, Serializable {
	...
	// collections
	private java.util.Set<com.harkon.jdocs.model.UserPermission> permissions;
	 ...
	 */
	public java.util.Set<com.harkon.jdocs.model.UserPermission> getPermissions () {
			return permissions;
	}
	 ...
	 */
	public void setPermissions (java.util.Set<com.harkon.jdocs.model.UserPermission> permissions) {
		this.permissions = permissions;
	}

	public void addTopermissions (com.harkon.jdocs.model.UserPermission userPermission) {
		if (null == getPermissions()) setPermissions(new java.util.TreeSet<com.harkon.jdocs.model.UserPermission>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.harkon.jdocs.model.UserType)) return false;
		else {
			com.harkon.jdocs.model.UserType userType = (com.harkon.jdocs.model.UserType) obj;
