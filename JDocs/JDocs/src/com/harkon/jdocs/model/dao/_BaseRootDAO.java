...
public abstract class _BaseRootDAO {
    ...
    public static void initialize() {
        com.harkon.jdocs.model.dao._RootDAO.initialize((String) null);
    }
    ...
    public static void initialize(String configFileName) {
        com.harkon.jdocs.model.dao._RootDAO.initialize(
                configFileName,
                com.harkon.jdocs.model.dao._RootDAO.getNewConfiguration(
                null));
    }
    ...
    public static void initialize(String configFileName, Configuration configuration) {
        if (null == configFileName && null != sessionFactory) {
            ...
            if (null == configFileName) {
                ...
                com.harkon.jdocs.model.dao._RootDAO.setSessionFactory(
