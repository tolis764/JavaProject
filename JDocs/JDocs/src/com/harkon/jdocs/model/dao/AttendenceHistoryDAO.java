...
//import com.harkon.jdocs.report.PayrollReportData;
...
public class AttendenceHistoryDAO extends BaseAttendenceHistoryDAO {
    ...
    public List<User> findNumberOfClockedInUserAtHour(Date fromDay, Date toDay, int hour, String userType) {
...
//			}
            ...
            throw new JDocsException("Error while calculating number of clocked in user", e);
        } finally {
            if (session != null) {
    ...
    public List<User> findNumberOfClockedInUserAtShift(Date fromDay, Date toDay, String userType) {
        Session session = null;
