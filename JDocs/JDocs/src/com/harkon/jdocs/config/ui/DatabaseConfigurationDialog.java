...
import com.harkon.jdocs.ui.TitlePanel;
import com.harkon.jdocs.ui.dialog.JDocsDialog;
import com.harkon.jdocs.ui.views.PasswordScreen;

public class DatabaseConfigurationDialog extends JDocsDialog implements ActionListener {
    ...
    protected void initUI() {
        ...
        btnFinish = new JButton(JDocsConstants.SAVE);
        btnFinish.setActionCommand(SAVE);
        btnExit = new JButton(JDocsConstants.CLOSE);
